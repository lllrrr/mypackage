...
DEFAULT_PACKAGES:=base-files libc libgcc busybox mtd uci opkg netifd fstools uclient-fetch logd urandom-seed urngd luci default-settings kmod-ipt-raw kmod-nf-nathelper kmod-nf-nathelper-extra
# For nas targets
