...
DEFAULT_PACKAGES:=base-files libc libgcc libustream-wolfssl busybox dropbear mtd uci opkg netifd fstools uclient-fetch logd urandom-seed urngd default-settings
# For nas targets
